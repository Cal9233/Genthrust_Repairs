      ...
      <div className="flex flex-col gap-3 sm:gap-4">
        <div>
          ...
          <p className="text-sm sm:text-[15px] text-muted-foreground font-normal">
            Search across 6,571 parts in 11 warehouse locations
          </p>
        </div>
        <div className="flex gap-2">
          <Button
            ...
            variant="outline"
            className="bg-white/10 hover:bg-white/20 border border-border hover:border-bright-blue rounded-lg px-4 sm:px-5 py-2.5 sm:py-3"
          >
            <RefreshCw className="h-4 w-4 sm:mr-2" />
            <span className="hidden sm:inline">Rebuild Index</span>
            <span className="sm:hidden ml-2">Rebuild</span>
          </Button>
        </div>
      </div>
